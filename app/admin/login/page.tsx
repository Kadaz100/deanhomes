...
import { Home, Shield, Lock, Mail, ArrowLeft, Key } from 'lucide-react'
...
export default function AdminLoginPage() {
  ...
  const ADMIN_ACCESS_KEY = 'DEANHOMES_ADMIN_2024' // Change this to your secret key
    ...
    <div className="min-h-screen bg-gray-50 flex items-center justify-center py-12 px-4 sm:px-6 lg:px-8">
      ...
      >
        ...
        <div className="text-center mb-8">
          ...
          <p className="text-gray-600 mt-2">Admin login requires special credentials</p>
        </div>
        ...
        <div className="bg-white rounded-2xl shadow-lg p-8 border-2 border-purple-200">
          <div className="bg-purple-50 border border-purple-200 rounded-xl p-4 mb-6">
            <div className="flex items-start space-x-3">
              ...
              <div>
                <p className="text-sm font-semibold text-purple-900 mb-1">Admin Access Only</p>
                <p className="text-xs text-purple-700">
                  This area is restricted to authorized administrators only. You must have a valid access key to proceed.
                </p>
              </div>
            </div>
          </div>
          ...
          <form onSubmit={handleSubmit} className="space-y-6">
            ...
            <div>
              ...
              <p className="text-xs text-gray-500 mt-2">
                Contact the system administrator to obtain an access key
              </p>
            </div>
